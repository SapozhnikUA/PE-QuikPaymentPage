...
PDF містить реквізити отримувача, IBAN, банк, МФО, ЄДРПОУ банку, таблицю з призначенням і сумою, суму прописом та місце для підпису. Кириличний шрифт вбудовується безпосередньо у файл — LibreOffice, wkhtmltopdf чи інші зовнішні залежності не потрібні.
