...
QR формується у тому самому форматі НБУ (BCD/002), що й QR на самій сторінці, але з призначенням, доповненим посиланням на рахунок: `<призначення>, згідно рахунку № <номер> від <дата>`. Кодування QR — власний векторний PHP-генератор (`qrcode.php`, версії 1–15, рівні корекції L/M), без сторонніх бібліотек чи розширень типу GD.
